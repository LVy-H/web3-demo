  ...
  group('ResultsBars', () {
    testWidgets('renders correct bar fractions from counts', (tester) async {
      await tester.pumpWidget(
        _host([_opt('Yes', 3), _opt('No', 1), _opt('Abstain', 0)]),
      );
    ...
    testWidgets('explicit total overrides the option sum', (tester) async {
      ...
      await tester.pumpWidget(
        _host([_opt('A', 3), _opt('B', 0)], total: BigInt.from(10)),
      );
      await tester.pumpAndSettle();
    ...
    testWidgets('highlights the single leader', (tester) async {
      await tester.pumpWidget(_host([_opt('Winner', 5), _opt('Runner-up', 2)]));
      await tester.pumpAndSettle();
    ...
    testWidgets('highlightLeader: false crowns nobody even with a clear leader '
      ...
      expect(
        find.byKey(ResultsBars.winnerKey),
        findsNothing,
    ...
    testWidgets('a tie shows no single winner', (tester) async {
      await tester.pumpWidget(
        _host([_opt('A', 4), _opt('B', 4), _opt('C', 1)]),
      );
      await tester.pumpAndSettle();
    ...
    testWidgets('zero total shows the empty state, no bars, no winner', (
      ...
      await tester.pumpWidget(_host([_opt('A', 0), _opt('B', 0)]));
      await tester.pumpAndSettle();
    ...
    testWidgets('zero total uses a custom empty label when provided', (
      ...
      expect(
        find.text('Votes are hidden until voters reveal after voting ends.'),
        findsOneWidget,
      );

...
void main() {
  ...
  test(
    'secret-ballot interop: create(secret) → getIssuer(hash ok) → register×3 '
    ...
    () async {
      ...
      for (var i = 0; i < 3; i++) {
        ...
        final credentialSig =
            blind_rsa.finalize(issuerPem, message, blindSig, blinded.state);
        serials.add(serial);
      ...
      await expectLater(
        ...
        throwsA(isA<ServerException>()
            .having((e) => e.isRegistrationClosed, 'isRegistrationClosed', isTrue)),
      );

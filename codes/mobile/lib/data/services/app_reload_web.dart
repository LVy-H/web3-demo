...
/// Web: reloading the page re-runs `main()`, which re-loads and re-applies the
/// saved network override. That reload IS the apply step for a hosted build —
/// so the config screen offers a one-tap "Reload to apply".

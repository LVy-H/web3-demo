...
const wasmBytes = readFileSync(new URL('../assets/zk/semaphore-16.wasm', import.meta.url))
const zkeyBytes = readFileSync(new URL('../assets/zk/semaphore-16.zkey', import.meta.url))

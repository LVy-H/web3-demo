...
const page = readFileSync(here('../assets/zk/prover_host.html'))
const wasm = readFileSync(here('../assets/zk/semaphore-16.wasm'))
const zkey = readFileSync(here('../assets/zk/semaphore-16.zkey'))
